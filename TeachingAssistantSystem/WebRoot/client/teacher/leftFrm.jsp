...
<body>
	...
	<ul>
		...
		<li><b>成绩管理</b>
    	<ul>
			<li><a href="${pageContext.request.contextPath}/servlet/GradeServlet?operation=tCheckGrade" target="middleFrame">查看成绩</a></li>
		</ul>
		<br/>
		</li>
		...
		<li><b>通知管理</b>
   	    <ul>
			<li><a href="${pageContext.request.contextPath}/client/teacher/releaseNotice.jsp" target="middleFrame">发布通知</a></li>
		...
		<li><b>资源管理</b>
    	<ul>
			<li><a href="${pageContext.request.contextPath}/client/teacher/uploadFile.jsp" target="middleFrame">上传文件</a></li>
